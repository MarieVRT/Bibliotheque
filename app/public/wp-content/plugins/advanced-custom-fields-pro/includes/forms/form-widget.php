...
*
*  All the logic for adding fields to fields
*
	...
	class acf_form_widget {
		...
		*/
		...
		function admin_enqueue_scripts() {
			...
			// validate screen
			if ( acf_is_screen( 'fields' ) || acf_is_screen( 'customize' ) ) {
...
(function($) {
	...
	acf.addFilter('find_fields', function( $fields ){
		...
		// not templates
		$fields = $fields.not('#available-fields .acf-field');
	...
	// on publish
	$('#fields-right').on('click', '.widget-control-save', function( e ){
	...
	// show
	$('#fields-right').on('click', '.widget-top', function(){
